...
async function initialize() {
    ...
    db.Orders.belongsTo(db.Customer, { foreignKey: "customerNumber" });
    db.orderDetails.belongsTo(db.Orders, { foreignKey: "orderNumber" });
    db.orderDetails.belongsTo(db.Product, { foreignKey: "productCode" });
